...
class User:
    ...
    def get_info(self):
       ...
       f" in {self.birthyear}, and email: {self.__email}.")
...
class Professor(User):
    ...
    def get_info(self):
        ...
        info+=f"{self.__work_years} year work experience with being {self.job}."
        return info
...
class Worker(User):
      ...
      def get_info(self):
          ...
          info+= f" email: {self.email}. Daily work hours - {self.__work_hours}, Salary - {self.salary}$,"
